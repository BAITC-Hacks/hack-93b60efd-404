...
ENV PYTHONDONTWRITEBYTECODE=1 PYTHONUNBUFFERED=1 VOICE_ROUTER_HOST=0.0.0.0 VOICE_ROUTER_STATIC_DIR=/app/frontend/dist
WORKDIR /app
COPY pyproject.toml ./
...
RUN useradd --system --uid 10001 voice && chown -R voice:voice /app
USER voice
EXPOSE 8000
